                ...
                <div className="ml-[425px]">
                    <ul className="flex items-center gap-[25px]">
                        ...
                        <div className="relative ml-3" ref={dropdownRef}>
                            ...
                            >
                                <img class="h-[45px] w-[45px] rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
                                    ...
                                    <ul className="flex flex-col">
                                        <NavLink to={'/profile'}>
                                            <div className="mt-3 mb-1 mx-3 py-3 border-b-2 border-opacity-40 border-customGray hover:shadow-xl flex flex-col items-center">
                                                <img class="h-[80px] w-[80px] rounded-full hover:shadow-xl" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
                                                <li className="text-center font-medium mt-1 hover:text-primary hover:font-bold">Alam</li>
