...
export const TermsCondition = () => {
  return (
    <>
      ...
      <div className="px-48">
        <h2 className="font-semibold text-2xl pt-8">Terms and Conditions</h2>{' '}
        <br />
        <p>Welcome to Bloodbags!</p> <br />
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Bloodbags&quot;s Website, located at blank. By accessing this
          website we assume you accept these terms and conditions. Do not
          continue to use Bloodbags if you do not agree to take all of the terms
        ...
        <p>
          ...
          <u>Terms & Conditions Generator</u>.
        </p>
        <br />
        <h2 className="font-semibold text-2xl">Cookies</h2> <br />
        <p>
          We employ the use of cookies. By accessing Bloodbags, you agreed to
          use cookies in agreement with the Bloodbags&apos;s Privacy Policy.
        ...
        <br />
        <h2 className="font-semibold text-2xl">License</h2> <br />
        <p>
          Unless otherwise stated, Bloodbags and/or its licensors own the
          intellectual property rights for all material on Bloodbags. All
          intellectual property rights are reserved. You may access this from
          Bloodbags for your own personal use subjected to restrictions set in
          these terms and conditions. You must not:
        </p>
        <br />
        <ul className="list-disc pl-7">
          <li>Republish material from Bloodbags</li>
          <li>Sell, rent or sub-license material from Bloodbags</li>
          <li>Reproduce, duplicate or copy material from Bloodbags</li>
        ...
        <p>
          ...
          Bloodbags does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Bloodbags,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Bloodbags shall
        ...
        <br />
        <p>
          Bloodbags reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Bloodbags a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Bloodbags; and (d) the link
        ...
        <p>
          ...
          sending an e-mail to Bloodbags. Please include your name, your
          ...
          Wait 2-3 weeks for a response. <br />
        ...
        <br />
        <p>
          No use of Bloodbags&apos;s logo or other artwork will be allowed for
          linking absent a trademark license agreement.
        </p>
        <h2 className="font-semibold text-2xl">iFrames</h2> <br />
        <p>
        ...
        <br />
        <h2 className="font-semibold text-2xl">Content Liability</h2> <br />
        <p>
        ...
        <br />
        <h2 className="font-semibold text-2xl">Reservation of Rights</h2> <br />
        <p>
        ...
        <br />
        <h2 className="font-semibold text-2xl">Disclaimer</h2> <br />
        <p>
