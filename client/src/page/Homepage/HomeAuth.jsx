            ...
            <div className="bg-background w-full mx-auto">
                <div className="min-h-screen">
                        ...
                        <section className="flex ">
                            <div className="z-10">
                                ...
                                <div className="mt-14 flex items-center">
                                    <Link to={'/jadwalDonor'}>
                                        <button className=" bg-primary rounded-3xl py-3 px-7 text-white text-base font-bold hover:bg-primaryHover focus:bg-primaryHover">
                                            Gabung Sekarang
                                        </button>
                                    </Link>
                    ...
                    <section className="flex mt-64">
                        <div className="pt-16 ml-28">
                            <h1 className="text-[60px] font-bold">
                                Infromasi Donor <br />
                                Darah yang Lengkap
                            </h1>

                            <h3 className="py-14 text-xl font-medium">
                                Informasi tempat dan event donor darah yang detail <br />
                        ...
                        <div className="flex ml-24 my-52">
                            ...
                            <div className="flex-col">
                                ...
                                <div className="pl-12 pt-8">
                                    <Link to={'/stokDarah'}>
                                        <button className="px-9 py-3 bg-primary rounded-[30px] font-bold text-[20px] text-white hover:bg-primaryHover focus:bg-primaryHover">
                                            Stok Darah
                                        </button>
                                    </Link>
                                </div>
